...
PROGRAM program_name ! <--- stand-alone program
IMPLICIT NONE ! <--- all variable MUST be declared
...
\begin{frame}[fragile]
\frametitle{Digression: file extensions}

\begin{itemize}
\item FORTRAN77:
\begin{itemize}
\item .f   $\leftarrow$ \emph{fixed-form} source code
\item Executable code between lines 7-72
\end{itemize}
\item Fortran90 and later:
\begin{itemize}
\item .f90     $\leftarrow$ \emph{free-form} source code
\end{itemize}
