      ...
      private
      public  :: obsData
      public  :: readNonConstantVars, readConstantVars
      public  :: allocateVariables, set_stationFileName
      public  :: printStationData, get_refDate, get_refTime
      public  :: get_totalNumRecords, get_freqMinute
...
!------------------------------------------------------------------------------
          subroutine readConstantVars(self)
            type(obsData),  intent(inOut) :: self
...
!------------------------------------------------------------------------------
          subroutine get_stationFileName(self, stationFileName)
            character(len=*), intent(out) :: stationFileName
            type(obsData),  intent(in) :: self
            stationFileName = self%stationFileName
          end subroutine get_stationFileName

          subroutine set_stationFileName(self, stationFileName)
            character(len=*),  intent(in) :: stationFileName
            type(obsData),  intent(inOut) :: self
            self%stationFileName = stationFileName
          end subroutine set_stationFileName
...
!---------Precipitation
      ...
      end module derivedTypeStationMod
