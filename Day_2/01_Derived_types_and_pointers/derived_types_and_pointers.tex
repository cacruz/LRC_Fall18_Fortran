...
\title{Derived types and pointers}
\author{Bruce Van Aartsen}
\institute{
  NASA GSFC Code 606 (ASTG)\\
  Greenbelt, Maryland 20771\\[1ex]
  \texttt{bruce.van.aartsen@nasa.gov}
}
...
\textcolor{red}{Derived types and pointers}
    \begin{itemize}
    \item F90 pointers
    \item Pointer syntax
    \item Dynamic memory allocation
    \item Pointers and array slices
    \item Pointers as arguments
    \item User derived types
    \end{itemize}
