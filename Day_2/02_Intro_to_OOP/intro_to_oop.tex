...
\centering{
\huge{
How does Fortran 2003+ support OOP?
}
}
...
\begin{frame}[fragile]{Function/procedure pointers}
  \FortranStyle
    \FontBcolumn
...
While not strictly an OO concept, function pointers (e.g. \emph{procedure :: some\_proc}) are a major part of the implementation of OO abstractions. \textbf{More on this later}.
\begin{itemize}
...
\begin{itemize}
  ...
  \item E.g. polymorphic variable \emph{myShape} of \emph{class Shape} will compute the compute area/perimeter according to type set at run time.
